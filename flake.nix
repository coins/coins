      ...
      in
      {
        ...
        devShells.serve = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            echo "  1. bash tests/mutinynet/setup-mutinynet.sh"
            echo "  2. bash scripts/stop-services.sh"
            echo "  3. cargo build --release"
            echo "  4. cd crates/coins-wallet/wasm && wasm-pack build --target web && cd -"
            echo "  5. serve-start"
            echo ""
            echo "After git pull (rebuild & restart):"
            echo "  serve-stop"
            echo "  cargo build --release"
            echo "  cd crates/coins-wallet/wasm && wasm-pack build --target web && cd -"
            echo "  serve-start"
            echo ""
            echo "Commands:"
            ...
            echo "  https://168.119.139.152/wallet/"
            echo "  https://168.119.139.152/explorer/"
            echo "  https://168.119.139.152/faucet/"
            echo ""
          '';
        };
      }
